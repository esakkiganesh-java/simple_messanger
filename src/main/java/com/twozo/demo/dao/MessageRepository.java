...
public class MessageRepository implements MessageDao {
	...
	public Collection<MessageResponseDto> getInboxMessages(int userId){
		...
		String query = "SELECT m.id AS message_id, m.sender_id, m.receiver_id, m.content AS message_content, m.sent_timestamp, " +
		...
		String query = "SELECT " +
		    ...
		    try (Connection connection = dataSource.getConnection();
		        ...
		        while (rs.next()) {
					...
					String timestamp = sentTimestamp.toInstant().toString();
		          //  Instant timeStamp = rs.getTimestamp("sent_timestamp").toInstant();
		            String senderName = rs.getString("sender_name");
		            String receiverName = rs.getString("receiver_name");

		            MessageResponseDto chat = new MessageResponseDto(messageId,receiverName,content,senderName,timestamp);
